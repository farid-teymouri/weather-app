...
export class WeatherRenderer {
    ...
    /**
     * Update temperature units display
     * @param {string} units - New temperature units
     */
    updateUnits(units) {
        const unitLabel = units === 'metric' ? '°C' : '°F';

        if (this.elements.temperatureUnit) {
            this.elements.temperatureUnit.textContent = unitLabel;
        }

        if (this.elements.unitDisplay) {
            this.elements.unitDisplay.textContent = unitLabel;
        }
